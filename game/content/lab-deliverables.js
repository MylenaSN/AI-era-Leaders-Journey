...
export const LAB_DELIVERABLES = {
  1: {
    ...
    why: "Antes de beber da ferramenta, o método. O mesmo pedido em dois modelos (GPT e Gemini). Compare só o gate — você vê onde cada um inventa ou respeita a trava humana.",
